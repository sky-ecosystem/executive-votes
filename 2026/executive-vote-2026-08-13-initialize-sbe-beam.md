...
If this executive proposal passes, then the Grove proxy spell will enable the `UNISWAP_V3_FACET` on the `ALLOCATOR-GROVE-A` Diamond PAU (DPAU) Controller and configure the AUSD/USDC pool with the following parameters:
