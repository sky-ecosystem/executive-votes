...
summary: Spell 1 actions for offboarding RWA001-A, remove Keeper Networks and update protocol name, update ALLOCATOR-SPARK-A DC-IAM risk parameters, increase the MKR-SKY Delayed Upgrade Penalty by 1 percent, whitelist proxy spells for Spark and Grove.
...
If this executive proposal passes, then the Delayed Upgrade Penalty applied to MKR-SKY conversions will increase by 1 percentage point, from 3% to **4%**.
